...
<body>
	<input type="text" id="picker" name="picker" class="form-control" style="width:100px;"/>
	<script type="text/javascript">
	$(function(){
		var datep = {
			     format: "h:mm a", //데이터 포맷 형식(yyyy : 년 mm : 월 dd : 일 )
		...
		$("#picker").datepicker(datep);
	});
	
	$("#picker").on("changeDate", function(e){
		console.log(e);
		console.log(e.date.valueOf());
		console.log(timestampToYYYYMMDD(e.date.valueOf(),''));
	})
	</script>
</body>
</html>